...
import CourseCurriculumUploads from './uploads/CourseCurriculum-uploads';
...
const handleDeleteClick = (id) => {
  ...
  return (
    <div>
      {
        openUploadBlog && (
          <CourseCurriculumUploads onClose={() => setOpenUploadBlog(false)}
      ...
      <div className='all-cu'>
        <div>
          <h1 className='text-light'>All CourseCurriculum</h1>
        </div>
        <div className=''>
          <button onClick={() => setOpenUploadBlog(true)} className='btn btn-warning'>Upload CourseCurriculum</button>
        </div>
      </div>
      <div>
