...
// import { singleBlogStart } from '../redux/actions/blogs/singleBlog.action'
...
//         console.log("Inquiry Data before dispatch:", inquiryData);
//         dispatch(uploadInquiryStart(inquiryData));
//         console.log("Inquiry data dispatched");
//         setInquiryData(initialInquiryData)
//         console.log("Inquiry Data after reset:", initialInquiryData);
...
//                                     </svg>
//                                     <div className="fee"> ₦ {blog?.price}/-</div>
//                                 </div>
...
//                         <h3>Who needs a {blog?.heading} ?</h3>
//                     </div>
...
//                                                             <select name="blogHeading" value={inquiryData.blogHeading} onChange={inputChange} className="form-control form-control-lg">
//                                                                 <option value="">{blog?.heading}</option>
//                                                             </select>
//                                                         </div>
//                                                     </div>
//                                                 </div>
